...
excel_path = "achievement.xlsx"
data = pd.read_excel(excel_path)

# Load the PowerPoint template
template_path = "Certificate_achievement.pptx"
output_folder = "achievement"
os.makedirs(output_folder, exist_ok=True)

# Define font and size settings for different tags
font_settings = {
    "<<Name>>": {"font": "Halant", "size": Pt(32)},
    "<<College>>": {"font": "Halant Bold", "size": Pt(20),"bold": True},
    "<<pl>>": {"font": "Halant Bold", "size": Pt(20),"bold": True},
    "<<jl>>": {"font": "Halant Bold", "size": Pt(20), "bold": True},
}
